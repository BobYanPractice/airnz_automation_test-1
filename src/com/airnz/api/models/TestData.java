...
public abstract class TestData {
    ...
    public enum TestDataType {
         ...
         * airpointsNumber, airpointsEarned, issuedDate, specialRequests.
         */
        TICKET
    ...
    private static TicketTestData buildTicketTestData(Map<String, String> p) {
        ...
        // Airpoints
        applyIfPresent(p, "airpointsNumber", builder::airpointsNumber);
        if (p.containsKey("airpointsEarned") && p.get("airpointsEarned") != null) {
            try { builder.airpointsEarned(Integer.parseInt(p.get("airpointsEarned"))); }
