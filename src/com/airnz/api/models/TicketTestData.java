...
public class TicketTestData extends TestData {
    ...
    private String airpointsNumber;

    @SerializedName("airpointsEarned")
    private int airpointsEarned;
    ...
    public String getAirpointsNumber() { return airpointsNumber; }
    public void setAirpointsNumber(String airpointsNumber) { this.airpointsNumber = airpointsNumber; }

    public int getAirpointsEarned() { return airpointsEarned; }
    public void setAirpointsEarned(int airpointsEarned) { this.airpointsEarned = airpointsEarned; }
    ...
    public static class Builder extends TestData.Builder<TicketTestData, Builder> {
        ...
        public Builder airpointsNumber(String airpointsNumber) {
            ticket.setAirpointsNumber(airpointsNumber);
            return self();
        }

        public Builder airpointsEarned(int airpointsEarned) {
            ticket.setAirpointsEarned(airpointsEarned);
            return self();
        }
