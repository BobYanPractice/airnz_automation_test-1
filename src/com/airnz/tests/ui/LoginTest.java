...
import com.airnz.core.config.DriverManager;
import com.airnz.core.listeners.TestListener;
import com.airnz.core.utils.TestDataLoader;
import com.airnz.pages.HomePage;
import com.airnz.pages.LoginPage;
...
public class LoginTest {
    ...
    @Test(description = "Verify Airpoints login", priority = 13)
    public void testAirpointsLogin() {
        Map<String, String> testData = TestDataLoader.getLoginData("airpointsLogin");
        
        HomePage resultPage = loginPage.loginWithAirpoints(
            testData.get("airpointsNumber"),
            testData.get("pin")
        );
        
        Assert.assertTrue(resultPage.isPageLoaded(), 
            "User should be logged in with Airpoints credentials");
    }
