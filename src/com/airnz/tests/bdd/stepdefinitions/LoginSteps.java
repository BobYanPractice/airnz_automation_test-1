package com.airnz.tests.bdd.stepdefinitions;
...
public class LoginSteps {
    ...
    @Given("I am on the Air New Zealand home page")
    ...
    @When("I login with Airpoints credentials")
    public void iLoginWithAirpointsCredentials() {
        Map<String, String> testData = TestDataLoader.getLoginData("airpointsLogin");
        homePage = loginPage.loginWithAirpoints(
