...
/**
 * TicketPage - Page Object for Air New Zealand Ticket/Passenger Details Page.
...
public class TicketPage extends BasePage {
    ...
    private WebElement addAirpointsLink;
    ...
    /**
     * Enters Airpoints number
     * @param airpointsNumber Airpoints number
     * @return TicketPage instance for chaining
     */
    public TicketPage enterAirpointsNumber(String airpointsNumber) {
        click(addAirpointsLink);
        type(airpointsNumberInput, airpointsNumber);
        logger.info("Entered Airpoints number: {}", airpointsNumber);
        return this;
    }
