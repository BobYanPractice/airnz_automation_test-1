...
import com.airnz.core.config.ConfigManager;

/**
 * HomePage - Page Object for Air New Zealand Home Page.
...
public class HomePage extends BasePage {
    ...
    /**
     * Navigates to Air New Zealand home page
    ...
    public HomePage navigateToHomePage() {
        ...
        waitForPageLoad();
        handleCookieBanner();
        logger.info("Navigated to Air New Zealand home page");
        return this;
    }
    ...
    /**
     * Navigates to Airpoints section
     */
    public void navigateToAirpoints() {
        click(airpointsNav);
        waitForPageLoad();
        logger.info("Navigated to Airpoints");
    }
